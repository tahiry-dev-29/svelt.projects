		...
		<div class="mx-auto md:w-2/3 lg:w-1/2">
			<div class="-m-2 flex flex-wrap">
				<div class="w-1/2 p-2">
					<div class="relative">
						...
						<input
							...
							id="name"
							name="name"
							class="bg-opacity-40 w-full rounded border border-gray-700 bg-gray-800 px-3 py-1 text-base leading-8 text-gray-100 transition-colors duration-200 ease-in-out outline-none focus:border-indigo-500 focus:bg-gray-900 focus:ring-2 focus:ring-indigo-900"
						/>
					</div>
				</div>
				<div class="w-1/2 p-2">
				...
				<div class="w-full p-2">
					<div class="relative">
						...
						<textarea
							id="message"
							name="message"
							class="bg-opacity-40 h-32 w-full resize-none rounded border border-gray-700 bg-gray-800 px-3 py-1 text-base leading-6 text-gray-100 transition-colors duration-200 ease-in-out outline-none focus:border-indigo-500 focus:bg-gray-900 focus:ring-2 focus:ring-indigo-900"
						></textarea>
					</div>
				</div>
				<div class="w-full p-2">
				...
				<div class="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
					<a class="text-indigo-400" href="/">example@email.com</a>
